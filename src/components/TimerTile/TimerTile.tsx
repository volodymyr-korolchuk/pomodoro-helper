  ...
  return (
    <div className="font-koulen flex flex-col mx-1">
      <button
        ...
        className={`bg-neutral-100 rounded-lg hover:bg-neutral-200 text-[45px] flex justify-center items-center ${
      ...
      <span
        className={`${
          isRunning
            ...
            : "bg-neutral-100 sm:text-[5rem] text-[4rem]"
      ...
      <button
        ...
        className={`bg-neutral-100 transition duration-150 rounded-lg hover:bg-neutral-200 text-[45px] flex justify-center items-center ${
          isRunning ? "opacity-0 pointer-events-none" : ""
        }`}
      >
        <IoIosArrowDown />
